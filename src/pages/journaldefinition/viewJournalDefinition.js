       ...
       try {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    result = dbData.approvejournaldefination(id.id, setApproval);
                            ...
                            <div className="form-group col-md-3">
                                ...
                                <div className="custom-control custom-switch">
                                    <input type="checkbox"
                                        ...
                                        defaultChecked={journal?.canAddMoreItems === "false" ? false : true}
                                        disabled
                                    />
                            ...
                            <div className="form-group col-md-3">
                                ...
                                <div className="custom-control custom-switch">
                                    <input type="checkbox"
                                        ...
                                        defaultChecked={journal?.canRemoveMoreItems === "false" ? false : true}
                                        disabled
                                    />
                            ...
                            <div className="form-group col-md-3">
                                ...
                                <div className="custom-control custom-switch">
                                    <input type="checkbox"
                                        ...
                                        id="autoGenerated"
                                        name="autoGenerated"
                                        defaultChecked={journal?.autoGenerated === "false" ? false : true}
                                        disabled
                                    />
