...
export default function CreateJournal() {
    ...
    const selectJournalDoc = (journDef) => {
        setValue("transactionRef", journDef.documentNo)
        ...
        setValue("autoGenerated", journDef.autoGenerated)
        setValue("source", journDef.source)
        setJournal(journDef)
                    ...
                    <div className="card-body">
                        ...
                        <form className="row newReceiptNote mt-5">
                            <div className="form-group col-md-3">
                                <label htmlFor="source">Source<span className='text-danger'>*</span>
                                    {errors.source &&
                                        ...
                                        <div className="card-body">
                                            <div className="table-responsive">
                                                <table className="table table-striped">
                                                    ...
                                                    <tbody>
                                                        {
                                                            journalDefinition?.data && journalDefinition?.data.length > 0 &&
                                                            journalDefinition?.data?.map((pro, index) => <tr key={pro.id}>
                                                                <td>
                                                                    {index + 1}
                                                                </td>
                                                                <td>
                                            ...
                                            {
                                                journalDefinition?.data.length === 0 &&
                                                <div className='row'>
                                                    <strong className='mx-auto mt-5 h3'>No Order Record</strong>
                                                </div>
                                            }
                                        </div>
                                        {/* {
