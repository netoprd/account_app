...
function initTables() {
   db.transaction(function (tx) {
      ...
      tx.executeSql('CREATE TABLE IF NOT EXISTS journalDetails(id INTEGER PRIMARY KEY, accountCode VARCHAR, credit NUMBER, debit NUMBER, journalDefinitionId NUMBER, parentguid VARCHAR, sn VARCHAR, transactionNarration VARCHAR)');
      ...
      tx.executeSql('INSERT INTO journal(approvedBy,  approvedOn, autoGenerated, journalDescription, journalguid, narration, transactionDate, transactionRef) VALUES (?,?,?,?,?,?,?,?)', [datatosave.approvedBy, datatosave.approvedOn, datatosave.autoGenerated, datatosave.journalDescription, datatosave.journalguid, datatosave.narration, datatosave.transactionDate, datatosave.transactionRef], function (tx, results) {
         if (results.insertId) {
            ...
            for (const item of datatosave.journalDetails) {
               tx.executeSql('INSERT INTO journalDetails(accountCode, credit, debit, journalDefinitionId, parentguid, sn, transactionNarration) VALUES (?,?,?,?,?,?,?)', [item.accountCode, item.credit, item.debit, parent, item.parentguid, item.sn, item.transactionNarration], function (tx, results) {
                  // console.log({ results });
                  // callback('success')
               }, function (e, r) {
                  console.log({ e });
