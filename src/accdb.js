...
const getchatofaccountbyId = function (id, callback) {
  ...
  const savejournalDefinition = function(datatosave, callback){
      let parent;
        ...
        db.transaction(function(tx) {
            ...
            tx.executeSql('INSERT INTO journalDefinitionDetails(journalDefinationId, accountCode, amount, canChangeAccountCode, canChangeAmount, canChangeIsCredited, compulsory, isCredited) VALUES (?,?,?,?,?,?,?,?)',[parent, item.accountCode, parseInt(item.amount), item.canChangeAccountCode, item.canChangeAmount, item.canChangeIsCredited, item.compulsory, item.isCredited], function (tx, results) {
               console.log({results});
                callback('success')              
            }, function (e, r) {
               console.log({e});
 ...
 const editjournalDefinition = function(id, datatoedit, callback){
